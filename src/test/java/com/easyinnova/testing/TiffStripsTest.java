...
*/
    ...
    assertEquals("xmp.iid:D501C27D082068118C14F1C6AB6A9EEE",
        to.getMetadataSingleString("InstanceID"));
    ...
    assertEquals("xmp.did:F77F1174072068118C14F1C6AB6A9EEE",
        to.getMetadataSingleString("DocumentID"));
    ...
    assertEquals("xmp.iid:F77F1174072068118C14F1C6AB6A9EEE",
        to.getMetadataSingleString("instanceID"));
    ...
    assertEquals("AF-S DX VR Zoom-Nikkor 18-200mm f/3.5-5.6G IF-ED [II]",
        to.getMetadataSingleString("Lens"));
    ...
    assertEquals(
        ...
        to.getMetadataSingleString("UserComment"));
    assertEquals(
        "[28,1,90,0,3,27,37,71,28,1,90,0,3,27,37,71,28,2,0,0,2,0,0,28,2,80,0,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,28,2,55,0,8,50,48,49,48,48,53,50,52,28,2,60,0,11,49,51,53,55,49,53,43,48,48,48,48,28,2,116,0,54,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32]",
  ...
  public void Test3() {
    ...
    assertEquals("1", to.getMetadataSingleString("Compression"));
    assertEquals("[3072000,3072000,3072000,3072000,3072000,2640000]",
        to.getMetadataSingleString("StripBYTECount"));
    ...
    assertEquals("[8,3072008,6144008,9216008,12288008,15360008]",
        to.getMetadataSingleString("StripOffsets"));
